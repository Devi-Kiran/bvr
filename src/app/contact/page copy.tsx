    ...
    return (
        <div className="pt-24 pb-16 bg-white">
                            ...
                            <div className="space-y-8">
                                ...
                                <div className="flex items-start bg-section p-6 rounded-xl hover:shadow-md transition-shadow">
                                    ...
                                    <div>
                                        ...
                                        <a href="tel:+919876543210" className="text-text-secondary hover:text-accent font-medium text-lg transition-colors">
                                            +91 98765 43210
                                        </a>
                                    </div>
                                </div>
            ...
            <section className="h-[400px]">
                ...
                <iframe src="https://www.google.com/maps/embed?pb=!1m18!1m12!1m3!1d243646.905100277!2d78.24323428680984!3d17.412608639151465!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x3bcb99daeaebd2c7%3A0xae93b78392bafbc2!2sHyderabad%2C%20Telangana!5e0!3m2!1sen!2sin!4v1772976157592!5m2!1sen!2sin" className="w-full h-full" style={{ border: 0 }} allowFullScreen loading="lazy" referrerPolicy="no-referrer-when-downgrade"></iframe>
            </section>
        </div>
    );
}
